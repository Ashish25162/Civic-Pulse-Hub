...
@WebServlet(urlPatterns = {"/User_Registeration"})
public class User_Registeration extends HttpServlet {
...
//se.setAttribute("name", name); 
        ...
        //    Class.forName("com.mysql.cj.jdbc.Driver");
         ...
         //   Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/Civic_Pulse_Hub", "root", "Ashu@@3450");
            ...
            PreparedStatement ps=cn.prepareStatement("insert into user(Name,Email,mobile,Password,address) values(?,?,?,?,?)");
            ps.setString(1, name);
