...
sess.setAttribute("report_id", report_id);
    ...
    <body>
        ...
        <%
            try {
                ...
                PreparedStatement psOperators = cn.prepareStatement("SELECT operator_id, full_name, email, phone, department, created_at FROM operator where department=?");
                psOperators.setString(1, department1);
            ...
            <%
                while(rsOperators.next()) {
                    ...
                    String created_at = rsOperators.getString("created_at");
                        sess.setAttribute("operator_id", rsOperators.getString("operator_id"));
            %>
                <tr>
                    <td><%= operator_id %></td>
                    <td><%= full_name %></td>
                    ...
                    <td><%= department %></td>
                    <td><%= created_at %></td>
                    <td><a href="Assign_Operator">Assign</a></td>
                </tr>
            <%
                }
